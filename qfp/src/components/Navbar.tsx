            ...
            <header className="fixed top-0 left-0 right-0 z-[1000] h-[60px] bg-background/90 backdrop-blur-xl border-b border-brand-border">
                <div className="max-w-[1280px] mx-auto h-full px-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-10">
                        {/* CRT Toggle */}
                        <button
                            onClick={() => window.dispatchEvent(new CustomEvent('toggle-crt'))}
                            className="btn btn-ghost !p-8 flex items-center justify-center group relative"
                            title="Retro CRT Mode"
                        >
                            <span className="text-[18px] group-hover:scale-110 transition-transform">📟</span>
                            <div className="absolute -bottom-2 px-6 py-1 bg-cyan-500/20 text-cyan-400 text-[8px] font-bold rounded-full opacity-0 group-hover:opacity-100 transition-opacity uppercase tracking-tighter border border-cyan-500/30">
                                CRT
                            </div>
                        </button>
